                ...
                <div class="card p-3">
                    <form @submit.stop.prevent="submitForm">
                        <div class="d-flex flex-row">
                            <div class="col-md-6">
                                <div class="form-group d-flex">
                                    <label for="categ" class="col-md-4"
                                        >Category</label
                                    >
                                ...
                                <div class="form-group d-flex">
                                    <label for="scateg" class="col-md-4"
                                        >Sub Category</label
                                    >
                                    <div class="col-md-8 p-0">
                                        <select
                                            :disabled="removedis.scat == 1"
                                            class="custom-select"
                                            id="scateg"
                                            v-model="subCategory"
                                            required
                        ...
                        <div>
                            <button
                                type="submit"
                                class="btn btn-primary btn-lg-sm btn-block"
                                name="submit"
                            >
                                Edit
                            </button>
...
export default {
    ...
    methods: {
        ...
        getSubCategory() {
            ...
            if (this.category != 0) {
                axios
                    .get("/api/subcategory/" + this.category)
                    .then((response) => {
        ...
        onDelete(id) {
            if (
                confirm(
                    "Are you sure to delete?(After deleting has to cash in)"
                )
            ) {
                axios
