    ...
    <section class="content">
        ...
        <div class="content" v-on:keyup="inputFocas($event)">
            <div class="row">
                <div class="col-md-9">
                    <div
                        class="card p-2 pt-4 d-flex flex-row justify-content-center"
                    >
                        <label for="rsw">Return Product</label>
                        <label class="switch">
                            <input type="checkbox" v-model="preturn" id="rsw" />
                    ...
                    >
                        <div
                            class="form-group d-flex flex-row col-md-4 align-items-center"
                        >
                            ...
                            <input
                                ...
                                v-on:change="selectByBarcode($event)"
                            />
                        </div>
                    ...
                    <input ref="codeInput" type="text" class="form-control" v-model="inputCode" v-on:change="selectByCode($event)">
                        ...
                        <div
                            class="form-group d-flex flex-row col-md-8 align-items-center"
                        >
                    ...
                    <div class="card p-2">
                        <table class="table">
                            ...
                            <Items
                                ...
                                @cal-sale-price="calSalePrice"
                                @cal-discount-price="calDiscountPrice"
                                :items="items"
                            />
                        </table>
                    </div>
...
export default {
    ...
    methods: {
        ...
        selectByCode(event) {
            var ob = this.products.filter(function (product) {
                if (product.code == event.target.value) return product;
            });

            if (ob.length > 0) {
                axios
                    .get("/api/product-info/" + ob[0].id)
                    .then((response) => {
                        // this.lots = response.data;
                        this.$refs["invoice_pre"].show();
                        this.inputCode = "";
